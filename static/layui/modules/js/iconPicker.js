  ...
  IconPicker.prototype.render = function (options) {
    ...
    var a = {
      ...
      createSelect: function () {
        var oriIcon = '<i class="fa layui-icon">';
      ...
      createList: function (text) {
        ...
        for (var i = 0; i < l; i++) {
          ...
          icon += '<i class="fa layui-icon ' + obj + '"></i>';
        ...
        if (page) {
          ...
          pageHtml = '<div class="layui-iconpicker-page" id="' + PAGE_ID + '">' +
            ...
            '<i class="fa layui-icon" id="' + PAGE_ID + '-prev" data-index="0" prev>&#xe603;</i> ' +
            '<i class="fa layui-icon" id="' + PAGE_ID + '-next" data-index="2" next>&#xe602;</i> ' +
            '</div>' +
            '</div>';
        }
